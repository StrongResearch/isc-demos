...
if __name__ == "__main__":
    ...
    tokenized_test_dataset = dataset["test"].map(
        ...
        desc="Tokenizing and preprocessing test dataset",
    )
    ...
    train_dataloader = DataLoader(
        tokenized_train_dataset, batch_size=args.batch_size, collate_fn=collate_fn, sampler=train_sampler
    )
    test_dataloader = DataLoader(
        tokenized_test_dataset, batch_size=args.batch_size, collate_fn=collate_fn, sampler=test_sampler
    )
    ...
    for epoch in range(train_dataloader.sampler.epoch, num_epochs):
        ...
        for batch in train_dataloader:
            ...
            if is_save_step:
                ...
                _metadata = dcp.save(state_dict=state_dict, storage_writer=checkpoint_writer)

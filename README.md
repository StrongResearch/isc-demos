...
3. From the **"Organisation Settings"** page you can alter the details of your organisation and *create* invitations for other members to join. **Note that Control Plane does not send

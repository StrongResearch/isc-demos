...
def main(args, timer):
    ...
    ## SUBSET FOR TESTING
    dataset_train = torch.utils.data.Subset(dataset_train, torch.arange(2*11*5)) # batch_size x nodes x iterations
    dataset_test = torch.utils.data.Subset(dataset_test, torch.arange(1*11*2))
